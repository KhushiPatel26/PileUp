          ...
          child: Column(
            ...
            children: [
                ...
                children: [Padding(
                  ...
                  Padding(
                    ...
                    child: ChoiceChip(
                      ...
                      elevation: 2,
                      selected: true, // You can customize the selected state as needed
                      // Add any other properties you need for the ChoiceChip
                    ),
                  ),],
              ),
              ...
              Row(
                children: [
                  Icon(
                    Icons.access_time,color: Colors.black,
                  ),
                  Padding(
                    padding: const EdgeInsets.only(left: 8.0),
                    child: Text(
                      "Start Date: " + widget.todotask.startDate,
              ...
              Row(
                children: [
                  ...
                  Padding(
                    padding: const EdgeInsets.only(left: 8.0),
                    child: Text(
                      "Due Date: " + widget.todotask.dueDate,
                      style: TextStyle(color: Colors.black),
                    ),
                  ),
                ],
              ...
              Padding(
                padding: const EdgeInsets.only(left: 8.0),
                child: Text(
                  "Create Date: " + widget.todotask.createDate,
                  style: TextStyle(color: Colors.black),
                ),
              ),
              ElevatedButton(
