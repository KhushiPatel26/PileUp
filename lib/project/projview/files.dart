    ...
    return SingleChildScrollView(
      child: Column(
        children: [
          ...
          Container(child: IconButton(onPressed: (){}, icon: Icon(Icons.picture_as_pdf,color: Colors.red,))),
          Container(child: IconButton(onPressed: (){}, icon: Icon(Icons.file_copy_rounded,color: Colors.red,))),
          Container(
            height: 900,
            color: Colors.white,
          )
